          ...
          <div className="contact-info">
            ...
            <div className="info-list">
              ...
              <div className="info-item">
                ...
                <div className="info-text">
                  <h3>Contact</h3>
                  <p><a href="mailto:hello@bistrotha.com" className="info-link">hello@bistrotha.com</a></p>
                  <p className="text-muted">For private event inquiries and press bookings.</p>
                </div>
              </div>
            </div>
          </div>
